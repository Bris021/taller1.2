    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apelllido_cliente', models.CharField(max_length=50, unique=True, verbose_name='Nombre')),
                ('edad', models.IntegerField()),
                ('correo', models.EmailField(max_length=254)),
                ('domicilio', models.TextField(help_text='Escriba una indicacion de tu domicilio', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='Producto',
